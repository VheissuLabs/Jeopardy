...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/karlm/Sites/jeopardy/public/storage' => 'string',
...
'filesystems.links./Users/karlm/Sites/jeopardy/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'mcp.redirect_domains','mcp.custom_schemes','mcp.authorization_server','nightwatch.enabled','nightwatch.token',
...
'boards.index','boards.store','boards.edit','boards.update','boards.destroy',
'categories.store','categories.update','categories.destroy','clues.store','clues.update',
'clues.destroy','games.store','games.show','host.console','host.begin',
'host.finish','host.open','host.judge','host.skip','screen.show',
'join.create','join.store','play.show','play.buzz','settings.redirect',
